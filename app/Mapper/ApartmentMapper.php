    ...
    public function results(array $data): ApartmentDTO
    {
        return new ApartmentDTO(
            ...
            attrs: new AttributesDTO(
                attrs__feet: $data['attrs']['attrs__feet'],
                attrs__type: $data['attrs']['attrs__type'],
                attrs__floor: $data['attrs']['attrs__floor'],
                attrs__remont: $data['attrs']['attrs__remont'],
                attrs__sanuzel: $data['attrs']['attrs__sanuzel'],
                attrs__district: $data['attrs']['attrs__district'],
                attrs__otoplenie: $data['attrs']['attrs__otoplenie'],
                attrs__sostoyanie: $data['attrs']['attrs__sostoyanie'],
            ),
            price: $data['price'],
